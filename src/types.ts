...
export const CHECKLIST_ITEMS: ChecklistItemDef[] = [
  ...
  { id: 9, title: 'Chấm điểm Quản lý tuân thủ qui định và qui trình', type: 'score', req: 'QL có mặt đầy đủ trong giờ làm việc\nQL sát sao, năng nổ trong công việc\nTuân thủ qui định của Công ty đối với QL' },
  { id: 10, title: 'Chấm điểm Nhân viên tuân thủ qui định và qui trình', type: 'score', req: 'Luôn dùng khay để bê đồ\nGhi tờ check đầy đủ\nLuôn có mặt tại bàn đảm bảo phục vụ tức thời khi khách có yêu cầu\nDọn bàn tuân thủ qui trình, đảm bảo sạch sẽ\nTuân thủ qui định của Công ty đối với NV' },
