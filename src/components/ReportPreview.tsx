      ...
      >
        ...
        <div className="text-center mb-8 border-b-2 border-slate-800 pb-6">
          ...
          <div className="text-sm text-slate-500 mt-1 italic">
            {formattedDate} - Thời gian ghi nhận: {data.timeRange || '...'}
          </div>
        </div>
                ...
                return (
                  <tr key={def.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-3 px-4 align-top">
                      ...
                      <div className="text-xs text-slate-500 leading-relaxed">{def.req}</div>
                    </td>
        ...
        <div className="mt-8 flex justify-between items-end text-sm text-slate-500">
          ...
          <div className="text-right">
            ...
            <p className="mt-8 font-medium text-slate-800">(Ký và ghi rõ họ tên)</p>
          </div>
        </div>
      </div>
    );
